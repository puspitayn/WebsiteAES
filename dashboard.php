                        ...
                        <div class="stat-widget-one">
                            ...
                            <div class="stat-content dib">
                                ...
                                <div class="stat-digit">
                                    <?php
                                    $karyawan = "select count(*) as 'jumlah' from USERSADMIN";
                                    $str = mysqli_query($connect, $karyawan);
                    ...
                    <div class="card-body">
                        <div class="stat-widget-one">
                            ...
                            <div class="stat-content dib">
                                ...
                                <div class="stat-digit">
                                    <?php
                                    $karyawan = "select count(*) as 'jumlahcus' from CUSTOMER";
                                    $str = mysqli_query($connect, $karyawan);
                                    while ($data = mysqli_fetch_array($str)) {
                                        echo $data['jumlahcus'];
                                    }
                    ...
                    <div class="card-body">
                        <div class="stat-widget-one">
                            ...
                            <div class="stat-content dib">
                                ...
                                <div class="stat-digit">
                                    <?php
                                    $produk = "select count(*) as 'jumlahProd' from PRODUK";
                                    $strproduk = mysqli_query($connect, $produk);
                                    while ($dataproduk = mysqli_fetch_array($strproduk)) {
                                        echo $dataproduk['jumlahProd'];
                                    }
                                    ?>
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="stat-widget-one">
                            <div class="stat-icon dib"><i class="ti-layout-grid2 text-warning border-warning"></i></div>
                            <div class="stat-content dib">
                                <div class="stat-text">Toko</div>
                                <div class="stat-digit">
                                    <?php
                                    $toko = "select count(*) as 'jumlahToko' from TOKO";
                                    $strtoko = mysqli_query($connect, $toko);
                                    while ($datatoko = mysqli_fetch_array($strtoko)) {
                                        echo $datatoko['jumlahToko'];
                                    }
                                    ?>
                                </div>
                            </div>
