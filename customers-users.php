                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        SALDO,USERNAME_CUSTOMER,PASSWORD_CUSTOMER,EXECUTION_TIME from CUSTOMER";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td scope="col">
                                                    <center>
                                                        <?php echo $data['PASSWORD_CUSTOMER']; ?>
                                                    </center>
                                                </td>
                                                <td scope="col">
                                                    <center>
                                                        <?php echo $data['EXECUTION_TIME']; ?>
                                                    </center>
                                                </td>
                                                ...
                                                <td>
                                                    <center>
                                                        ...
                                                        <a href="gmail.php?id=<?php echo $data['ID_CUSTOMER']; ?>">
                                                            <button type="submit" class="btn btn-warning btn-sm" name="aksi">
                                                                <i class="fa fa-dot-circle-o"></i> Reminder
                                                            </button>
                                                        </a>
                                                    </center>
                                                </td>
