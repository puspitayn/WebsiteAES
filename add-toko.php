...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <!-- Header-->
        <?php
        $sql_id = "select max(ID_TOKO) as kode from TOKO WHERE ID_TOKO like '%TK%'";
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header"><strong>Form Input Toko</strong></div>
                            <form method="POST" action="registration-process.php?mode=simpanToko">
                                <div class="card-body card-block">
                                    <div class="row form-group">
                                        <div class="col-4">
                                            <input style="text-align:center" type="text" class="form-control" id="ID_TOKO" name="ID_TOKO" value="<?= $kode ?>" readonly>
                                        </div>
                                        <div class="col-8">
                                            <input style="text-align:center" type="text" class="form-control" id="ID_ADMIN" name="ID_ADMIN" placeholder="Your ID" required="">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class=" col-6"><input type="text" class="form-control" id="NAMA_TOKO" name="NAMA_TOKO" placeholder="Nama Toko" required=""></div>
                                        <div class="col-6"><input type="text" class="form-control" id="NAMA_PEMILIK_TOKO" name="NAMA_PEMILIK_TOKO" placeholder="Nama Pemilikr" required=""></div>
                                    </div>
                                    <input type="submit" class="btn btn-primary btn-flat m-b-30 m-t-30" name="simpanToko" value="Simpan">
                                </div>
                            </form>
                        </div>
                    </div>
